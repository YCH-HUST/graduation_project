...
SECRET_KEY = 'django-insecure-tcm-diagnosis-system-2024-graduation-project'
...
# Trust proxy headers (Caddy -> FRP -> Django)
...
STATIC_URL = 'static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles') # 收集后的存放地
...
PIPELINE_SERVICES = {
    ...
    'SYNDROME': {
        'url': 'http://localhost:8003/syndrome/infer',
        'timeout': 30,
    },
    'EXPLANATION': {
        'url': 'http://localhost:8004/explain/generate',
        'timeout': 30,
    },
}
